...
### Базовое ML tree
```markdown
### Традиционное машинное обучение (ML classic)
...
|__Методы адаптации
|____Точная настройка (Fine-tuning)[Bert family, 1000+id]
|____Обучение с малым числом примеров (Few-shot)[LLM API, 100-1000id]
|____Запрос без параметров (Zero-shot)[MLM-LLM, без тренировки]
|____Инженерия промптов (Prompt Engineering)[API, прямое обращение]
|__Архитектуры
...
### Векторизация
- процесс преобразования нечисловых данных в числовые векторы, которые могут быть обработаны ML-алгоритмами

### Почему это критически важно:
- Большинство ML-алгоритмов работают только с числовыми данными
- Качество векторизации напрямую влияет на результаты модели
- Правильная векторизация сохраняет семантические отношения в данных
```
допишу
```
